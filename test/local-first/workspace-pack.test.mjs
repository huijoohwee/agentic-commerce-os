...
test('public profile binds the pinned Graph artifact, exact assets and source without dispatching providers', async () => {
  ...
  for (const [route, asset] of [['/', '/workspace-pack.html'], ['/workspace-pack.js', '/workspace-pack.js'], ['/workspace-pack.css', '/workspace-pack.css'], ['/workspace-pack.simulation.js', '/workspace-pack.simulation.js'], ['/workspace-pack.console.js', '/workspace-pack.console.js']]) {
  ...
  assert.deepEqual(authoredAssets(revision).filter(asset => asset.path.startsWith('services/')).map(asset => asset.path).sort(),
    ['services/workspace-pack/', 'services/workspace-pack/workspace-pack.console.js', 'services/workspace-pack/workspace-pack.css', 'services/workspace-pack/workspace-pack.js', 'services/workspace-pack/workspace-pack.simulation.js']);
});
