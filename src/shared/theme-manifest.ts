...
export const THEME_MANIFEST_DEFAULTS: ThemeManifest = Object.freeze({
  ...
  copy: Object.freeze({
    ...
    subhead: 'Discover useful offers from independent businesses. Find your next outcome, review the details, and decide with confidence.',
    footer: 'Agentic Commerce OS · Independent businesses, useful outcomes',
  }),
